...
java -Xms64m -Xmx128m -jar -Dasw.sentence.sentenceservice.instancename=S-ASYNC -Dasw.sentence.sentenceservice.delay=50 sentence-service-async/build/libs/sentence-async.jar &

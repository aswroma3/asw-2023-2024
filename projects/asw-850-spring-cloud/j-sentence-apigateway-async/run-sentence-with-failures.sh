...
echo Starting Word Services [subject*1 failureRate=35 + verb*1 + object*1 failureRate=25]
java -Xms64m -Xmx128m -jar -Dspring.profiles.active=subject -Dasw.sentence.wordservice.instancename=s1 -Dasw.sentence.wordservice.failurerate=35 word-service/build/libs/word.jar &
...
java -Xms64m -Xmx128m -jar -Dasw.sentence.sentenceservice.instancename=S-SYNC sentence-service/build/libs/sentence.jar &
java -Xms64m -Xmx128m -jar -Dasw.sentence.sentenceservice.instancename=S-ASYNC sentence-service-async/build/libs/sentence-async.jar &
